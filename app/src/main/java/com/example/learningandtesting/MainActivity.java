...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClick(View view)
        ...
        if (content.equals("Password")) {
            startActivity(new Intent(MainActivity.this, SongSelectionTest.class)); //navigates to another activity
        } else {
            toastMsg("Wrong NERD!"); //Displays a pop up message that says "Wrong NERD!"
        }
    }
}